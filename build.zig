...
pub fn init(b: *std.Build, dep: *std.Build.Dependency) [2]Example {
    ...
    // std.debug.print("{s}\n", .{@src().file});
    return .{
        .{ .target = f446re, .name = "STM32F446", .file = "src/main.zig", .board_name = "f446_board", .bsp_file = "src/bsp/stm32f446.zig" },
        .{ .target = f401cc, .name = "STM32F401", .file = "src/main.zig", .board_name = "f401_board", .bsp_file = "src/bsp/stm32f401.zig" },
    };
}
